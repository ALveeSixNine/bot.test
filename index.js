...
/*const dashboard = http.createServer(function (_req, res) {
    ...
    res.write("HI! THIS BOT WAS MADE BY ALvee");
    res.end();
});
...
axios.get("https://raw.githubusercontent.com/ALveeSixNine/ALvee69/main/package.json").then((res) => {
  logger(res['data']['name'], "[ NAME ]");
  logger("Version: " + res['data']['version'], "[ VERSION ]");
  logger(res['data']['description'], "[ DESCRIPTION ]");
});
startBot();
/*axios.get("https://raw.githubusercontent.com/ALveeSixNine/miraiv2/main/package.json").then((res) => {
